...
');
	...
	public function actionQuality_policies()
	{
		$this->layout='//layouts/column2';

		$this->pageTitle = 'Quality Policies'.$this->pageTitle;
		$this->render('quality-policies', array(
			'model'=>$model,
		));
	}

	public function actionSolutions_bluebottle()
	{
		$this->layout='//layouts/column2';

		$this->pageTitle = 'Solutions BlueBottle'.$this->pageTitle;
		$this->render('solutions-bluebottle', array(
			'model'=>$model,
		));
	}

	public function actionSolutions_capabilities()
	{
		$this->layout='//layouts/column2';

		$this->pageTitle = 'Solutions Capabilities'.$this->pageTitle;
		$this->render('solutions-capabilities', array(
			'model'=>$model,
		));
	}
	...
	// 	$this->pageTitle = 'Home'.$this->pageTitle;
	// 	$this->render('index', array(
	// 		'model'=>$model,
	// 	));
	// }
	...
	public function actionAkademikprogramsarjana()
	{
		$this->layout='//layouts/column2';
	...
	public function actionAkademiksiadri()
	{
		$this->layout='//layouts/column2';
	...
	public function actionKomunitasberita()
	{
		$this->layout='//layouts/column2';
	...
	public function actionKomunitasberitadetail()
	{
		$this->layout='//layouts/column2';
	...
	public function actionPenerimaansarjana()
	{
		$this->layout='//layouts/column2';
	...
	public function actionTentangfakta()
	{
		$this->layout='//layouts/column2';
	...
	public function actionTentanginfo()
	{
		$this->layout='//layouts/column2';
	...
	public function actionTentanginfokampus()
	{
		$this->layout='//layouts/column2';
	...
	public function actionTentangadministrasi()
	{
		$this->layout='//layouts/column2';
