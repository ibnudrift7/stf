...
<div class="widgetcontent">
	...
	<div class="row-fluid">
		<div class="span6">
			<?php echo $form->textAreaRow($model,'content_id',array('rows'=>4, 'class'=>'span8 redactor')); ?>
		</div>
		<div class="span6">
			<?php echo $form->textAreaRow($model,'content_en',array('rows'=>4, 'class'=>'span8 redactor')); ?>
		</div>
	</div>
	<div class="divider10"></div>
	...
	<?php echo $form->fileFieldRow($model,'image',array(
			...
			<div class="control-group">
				...
				<div class="controls">
					<a target="_blank" href="<?php echo Yii::app()->baseUrl.'/images/extensi/'. $value->image ?>"><i class="fa fa-pdf"></i> View Files</a>
				</div>
			</div>
			<?php endif; ?>
