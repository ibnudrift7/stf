<div class="row-fluid">
	<div class="span8">
		...
		<div class="widgetcontent">
			...
			?>
			<?php echo $form->hiddenField($model,'name',array('class'=>'span5','maxlength'=>225)); ?>
			...
			foreach ($modelDesc as $key => $value) {
			    ...
			    echo $form->textField($value,'['.$lang->code.']title',array('class'=>'span11', 'maxlength'=>100));
			    ?>
			...
			'hint'=>'<b>Note:</b> Ukuran gambar adalah 147 x 147px. Gambar yang lebih besar akan ter-crop otomatis, tolong upload foto ukuran horizontal')); ?>
			<?php if ($model->scenario == 'update'): ?>
			<div class="control-group">
				<label class="control-label">&nbsp;</label>
				<div class="controls">
				<div style="max-width: 25%;">
				<img class="img-polaroid" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(147,147, '/images/testimoni/'.$model->image , array('method' => 'adaptiveResize', 'quality' => '90')) ?>"/>
				</div>
				</div>
			</div>
			<?php endif; */ ?>
