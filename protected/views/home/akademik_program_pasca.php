        ...
        <div class="row kecil">
            <div class="col-md-60">
                ...
                <div class="box-content">
                    <div class="garis"></div>
                    <h5>Ilmu Teologi - Program Studi S2</h5>
                    ...
                    <button class="baca"><a href="<?php echo CHtml::normalizeUrl(array('/home/akademikprogramdetil', 'name'=> 'Ilmu Teologi - Program Studi S2', 'type'=>'program-pasca-sarjana')); ?>">Baca Lebih Lanjut</a></button>
                    <button class="daftar"><a href="#">Mendaftar</a></button>
                </div>
                <div class="box-content">
                    <div class="garis"></div>
                    <h5>Ilmu Filsafat - Program Studi S2</h5>
                    <p>Curabitur tempor lectus quam, id consectetur urna commodo vitae. Praesent ornare metus neque, id bibendum nulla tempus a. In eu placerat libero. Curabitur tempor lectus quam, id consectetur urna commodo vitae. Praesent ornare metus neque, id bibendum nulla tempus a. In eu placerat libero.</p>
                    <button class="baca"><a href="<?php echo CHtml::normalizeUrl(array('/home/akademikprogramdetil', 'name'=> 'Ilmu Filsafat - Program Studi S2', 'type'=>'program-pasca-sarjana')); ?>">Baca Lebih Lanjut</a></button>
                    <button class="daftar"><a href="#">Mendaftar</a></button>
                </div>
            </div>
        </div>
