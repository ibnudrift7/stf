    ...
    <div class="pos-tops_submenu">
        <div class="prelatife container">
            <ul class="list-inline">
                ...
                <li class="list-inline-item <?php if ($actives == 'program-sarjana' or $_GET['type'] == 'program-sarjana'): ?>active<?php endif; ?>"><a href="<?php echo CHtml::normalizeUrl(array('home/akademikprogramsarjana', 'lang'=>Yii::app()->language)); ?>"><?php echo Tt::t('front', 'program sarjana') ?></a></li>
