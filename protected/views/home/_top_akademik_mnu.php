    ...
    <div class="pos-tops_submenu">
        <div class="prelatife container">
            <ul class="list-inline">
                ...
                <li class="list-inline-item <?php if ($actives == 'kalendar-akademik' or $_GET['type'] == 'kalendar-akademik'): ?>active<?php endif; ?>"><a href="<?php echo CHtml::normalizeUrl(array('home/akademikcalendar')); ?>">Kalendar Akademik</a></li>
            </ul>
